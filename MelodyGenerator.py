...
class MelodyGenerator:
    ...
    def __init__(self, model_path="/content/drive/MyDrive/5th_project/model_final.h5"):
    ...
    def save_melody(self, melody, step_duration=0.25, format="midi", file_name="E:/G_project/mel.mid"):
