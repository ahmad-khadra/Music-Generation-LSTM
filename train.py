...
EPOCHS = 50
BATCH_SIZE = 64
SAVE_MODEL_PATH = "/content/drive/MyDrive/5th_project/model_final.h5"
KERN_DATASET_PATH = "/content/drive/MyDrive/deutschl"
SAVE_DIR = "/content/drive/MyDrive/5th_project/dataset_final"
SINGLE_FILE_DATASET = "/content/drive/MyDrive/5th_project/file_dataset_final"
MAPPING_PATH = "/content/drive/MyDrive/5th_project/mapping_final.json"
SEQUENCE_LENGTH = 32
